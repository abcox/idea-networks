...
namespace proquote
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Idea Networks API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Idea Networks API v1");
                c.RoutePrefix = string.Empty;
            });

            app.UseHttpsRedirection();
            app.Map("/api/values", delegate { }); // disable ValuesController
            app.UseMvc();
        }
    }
}
